...
describe CardConnect::Service::ProfilePutResponse do
  ...
  describe 'FIELDS' do
    it 'should have profile id' do
      expect(@response.profileid).must_equal '12305454023615201322'
    end
    ...
    it 'should have response code' do
      expect(@response.respcode).must_equal '09'
    end

    it 'should have response text' do
      expect(@response.resptext).must_equal 'Profile Saved'
    end
    ...
    it 'should have ssnl4' do
      expect(@response.ssnl4).must_equal '3655'
    end
    ...
    it 'should have defaultacct' do
      expect(@response.defaultacct).must_equal 'Y'
    end
    ...
    it 'should have token' do
      expect(@response.token).must_equal '9441149619831111'
    end
  ...
  describe '#body' do
    it 'should generate hash with all the right values' do
      expect(@response.body).must_equal symbolize_keys(valid_profile_put_response)
    end
  end
end
